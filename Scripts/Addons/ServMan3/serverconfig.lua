...
local config = 
{
	...
	MOTD						= "*MOTD: Type /help into chat to see enabled server commands*You can use these commands to start a missionvote or a votekick!",
